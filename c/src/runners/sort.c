...
int main(int argc, char *argv[]) {
    ...
    void (*sorts[6])(int*, unsigned int) = {insertion_sort, merge_sort, quick_sort, randomized_quick_sort, count_sort, radix_sort};
    ...
    printf("%s,%lf,%lf,%lf\n", sort_names[algoritmo], time_spent_random, time_spent_best, time_spent_worse);
    return 0;
}